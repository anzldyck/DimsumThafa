...
<nav class="navbar navbar-expand-md navbar-dark fixed-top bg-custom">
    <div class="container">
        <a class="navbar-brand" href="<?= base_url() ?>" style="font-family: 'Poppins', sans-serif;">Dimsum Thafa</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mx-auto">
                <li class="nav-item">
                    <a class="nav-link font-weight-bold text-white" href="<?= base_url('home') ?>">Home <span class="sr-only">(current)</span></a>
                </li>
                <?php if ($this->session->userdata('is_login') && $this->session->userdata('role') == 'admin') : ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold" href="<?= base_url('product') ?>">Product</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold" href="<?= base_url('order') ?>">Order</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link font-weight-bold" href="<?= base_url('user') ?>">Pengguna</a>
                    </li>
                <?php endif; ?>
            </ul>
            <ul class="navbar-nav">
